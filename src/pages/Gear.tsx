  ...
  return (
    ...
    >
      ...
      <section className="mb-10 flex gap-6 flex-wrap justify-center px-4 tablet:px-20">
        <CardGear
          image={
            'https://th.bing.com/th/id/OIP.Fsy9ajZBAUKuJV_YBSGjcQHaIE?pid=ImgDet&rs=1'
          }
          title={'Monitor'}
        ...
        <CardGear
          image={
            'https://th.bing.com/th/id/OIP.-ypqXdjsPvxIxuZtopQNogHaHa?pid=ImgDet&w=800&h=800&rs=1'
          }
        ...
        <CardGear
          image={
            'https://www.tunisianet.com.tn/155061-large/processeur-amd-ryzen-5-1600-af.jpg'
          }
          title={'Processador'}
        ...
        <CardGear
          image={
            'https://th.bing.com/th/id/R.350a94e8ef793335c7a71642d6ba4e20?rik=wSnvPiwaJAXj8A&pid=ImgRaw&r=0'
          }
          title={'Mémoria Ram'}
        ...
        <CardGear
          image={
            'https://www.lojamegabrasil.com.br/image/cache/catalog/0placa%20mae/ab350m-1450x1450.jpg'
          }
          title={'Placa Mãe'}
        ...
        <CardGear
          image={
            'https://dattocommerce.azureedge.net/0-master/productimages/4e/56b393368461d5.jpg?width=1500&height=1500&scale=canvas'
          }
          title={'Cooler'}
        ...
        <CardGear
          image={
            'https://media.pichau.com.br/media/catalog/product/cache/2f958555330323e505eba7ce930bdf27/g/p/gp-p550b4.jpg'
          }
          title={'Fonte'}
        ...
        <CardGear
          image={
            'https://cdn.shopify.com/s/files/1/0381/0807/0028/products/imageTemplate1500x1500_2x_8cbc833a-6717-4aa3-bbbf-65d499f4f2ca_1024x1024@2x.png?v=1588446034'
          }
          title={'SSD'}
        ...
        <CardGear
          image={
            'https://th.bing.com/th/id/OIP.DhDYJVtTL2EFXZH-MswM0QHaHa?pid=ImgDet&rs=1'
          }
          title={'Gabinite'}
        ...
        <CardGear
          image={
            'https://www.umpoukodetudo.com.br/media/catalog/product/cache/1/image/1000x/9df78eab33525d08d6e5fb8d27136e95/i/m/import-3.jpg'
          }
          title={'Teclado'}
        ...
        <CardGear
          image={
            'https://th.bing.com/th/id/OIP.3V1IXPhdmMPM7MiTd6SXzQHaHa?pid=ImgDet&rs=1'
          }
          title={'Mouse'}
        ...
        <CardGear
          image={
            'https://th.bing.com/th/id/R.4c77bca88aa959fe7ced79f274a66a2e?rik=4jowYmGSSHgthg&pid=ImgRaw&r=0'
          }
          title={'Headset'}
