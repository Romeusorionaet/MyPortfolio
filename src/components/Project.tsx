...
export function Project({
  ...
  const isInProduction = AOSanimation
    ? '-mb-2 p-2 rounded-full shadow-lg text-sm border-b-2 active:border-green-400 opacity-80 hover:opacity-100 duration-300'
    : 'p-2 rounded-full border-b-2 border-red-500 opacity-90 cursor-not-allowed'

  return (
    <div className="bg-gradient-to-r from-blue-800 rounded-3xl mt-10 w-[18rem] tablet:w-30 mx-auto pb-2">
